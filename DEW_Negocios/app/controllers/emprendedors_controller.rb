class EmprendedorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @emprendedor.save
        format.html { redirect_to @emprendedor, notice: 'El emprendedor ha sido creado sastifactoriamente.' }
  ...
  def update
    ...
    respond_to do |format|
      if @emprendedor.update_attributes(params[:emprendedor])
        format.html { redirect_to @emprendedor, notice: 'Se ha actualizado los datos del Emprendedor sastifactoriamente.' }
